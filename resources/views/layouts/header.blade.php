<header class="navbar pt-0 px-4 flex-shrink-0">
    <div class="d-flex align-items-center">
        ...
        <h1 class="navbar-brand text-white h5 pt-0 nav-heading">
    ...
    >
      ...
      <button class="btn text-white p-0 position-relative">
        <i class="bi bi-bell icon"></i>
        <span
          class="bg-danger position-absolute rounded-circle bell-badge"
        ></span>
      </button>
